...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(20, 17, 200, 20))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(20, 290, 100, 20))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(20, 310, 100, 16))
        self.label_3.setObjectName("label_3")
        self.label_Puan = QtWidgets.QLabel(Dialog)
        self.label_Puan.setGeometry(QtCore.QRect(150, 294, 47, 13))
        self.label_Puan.setObjectName("label_Puan")
        self.label_Yanlis = QtWidgets.QLabel(Dialog)
        self.label_Yanlis.setGeometry(QtCore.QRect(150, 312, 47, 13))
